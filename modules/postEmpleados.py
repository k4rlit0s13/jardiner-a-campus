...
def actualizarCodigoEmpleado(id):
...
def actualizarNombreEmpleado(id):
...
def actualizarApellidosEmpleado(id):
...
def actualizarExtensionEmpleado(id):
...
def actualizarCodigoJefeEmpleado(id):
...
def actualizarPuestoEmpleado(id):
...
╚══════╝╚═╝     ╚═╝╚═╝     ╚══════╝╚══════╝╚═╝  ╚═╝╚═════╝  ╚═════╝ ╚══════╝     
        ...
        4. Actualizar extension
        5. Actualizar email
        6. Actualizar codigo oficina
        7. Actualizar codigo jefe
        8. Actualizar puesto
        9. Actualizar id

        10. Actualizar todas las anteriores     
        ...
        if(re.match(r'[0-9]+$',opcion)is not None):
                ...
                if opcion>=0 and opcion<=10:  
                    ...
                    if opcion == 1:
                        ...
                        print(tabulate(actualizarCodigoEmpleado(id),headers="keys",tablefmt="grid"))

                    if opcion == 2:
                        id=input("Ingrese la id del cliente que desea actualizar: ")
                        print(tabulate(actualizarNombreEmpleado(id),headers="keys",tablefmt="grid"))

                    if opcion == 3:
                        id=input("Ingrese la id del cliente que desea actualizar: ")
                        print(tabulate(actualizarApellidosEmpleado(id),headers="keys",tablefmt="grid"))

                    if opcion == 4:
                        id=input("Ingrese la id del cliente que desea actualizar: ")
                        print(tabulate(actualizarExtensionEmpleado(id),headers="keys",tablefmt="grid"))

                    if opcion == 5:
                        id=input("Ingrese la id del cliente que desea actualizar: ")
                        print(tabulate(actualizarEmailEmpleado(id),headers="keys",tablefmt="grid"))

                    if opcion == 6:
                        id=input("Ingrese la id del cliente que desea actualizar: ")
                        print(tabulate(actualizarCodigoOficinaEmpleado(id),headers="keys",tablefmt="grid"))

                    if opcion ==7:
                        id=input("Ingrese la id del cliente que desea actualizar: ")
                        print(tabulate(actualizarCodigoJefeEmpleado(id),headers="keys",tablefmt="grid"))

                    if opcion == 8:
                        id=input("Ingrese la id del cliente que desea actualizar: ")
                        print(tabulate(actualizarPuestoEmpleado(id),headers="keys",tablefmt="grid"))

                    if opcion == 9:
                        id=input("Ingrese la id del cliente que desea actualizar: ")
                        print(tabulate(actualizaridNueva(id),headers="keys",tablefmt="grid"))
